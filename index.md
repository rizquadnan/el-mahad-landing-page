...
<html lang="id">
  ...
  <body>
    <header>
      <nav class="grid">
        ...
        <ul>
          ...
          <li>
            <a class="sign-in" href="sign-in.html" title="Sign in">Sign in</a>
          </li>
          <li>
            <a class="daftar" href="daftar.html" title="Daftar sekarang!">Daftar</a>
          </li>
        </ul>
        <div id="side-menu" class="side-nav">
          ...
          <a href="sign-in.html" class="sign-in" title="Sign in">Sign in</a>
          <a href="daftar.html" class="daftar" title="Daftar sekarang!">Daftar</a>
        </div>
      </nav>
      <section class="hero">
        <div class="hero-text">
    ...
    <section class="grupTargetUser">
      ...
      <p>Program kami dibuat dengan tujuan untuk mencapai kebahagian dunia 
        dan akhirat. Dibuat untuk semua orang, terlebih bagi :</p>
      <div>
    ...
    <section class="grupFitur">
      ...
      <div class="grid">
        ...
        <div class="fitur fitur-cta">
          ...
          <a href="daftar.html" title="Daftar sekarang!" class="cta">Daftar</a>
        </div>
      </div>
    </section>
    ...
    <div class="tanya-kami-wrapper">
      <div class="tanya-kami">
        ...
        <form action="">
          <input type="name" class="tanya-kami__form" name="nama-penanya" id="nama-penanya" placeholder="Nama lengkap" required>
          <label for="nama-penanya"></label>
          <input type="name" class="tanya-kami__form" name="email-penanya" id="email-penanya" placeholder="Email" required>
          <label for="email-penanya"></label>
          <div class="tanya-kami__form__wrapper">
            <input type="text" class="tanya-kami__form tanya-kami__form--isi-pesan" name="pesan-penanya" id="pesan-penanya" placeholder="Isi pesan" required>
            <label for="pesan-penanya"></label>
          </div>
