...
<html lang="id">
  ...
  <body>
    <header>
      <nav class="grid">
        <div class="logo">
          <a href="/index.html">
            <picture>
              <source type="image/webp" srcset="assets/mobile/logo-elmahad-nav.webp">
      ...
      <div class="grupPartners">
        <picture>
          <source type="image/webp" 
                  src="assets/mobile/hsi-desktop.webp"
                  srcset="assets/mobile/hsi-desktop.webp 150w, assets/mobile/hsi-mobile.webp 200w"
                  sizes="(max-width: 1299px) 15vw, 150px">
          <img src="assets/mobile/stdi@2x.png" alt="Logo HSI Abdullah Roy" />
        </picture>
        <picture>
          <source type="image/webp" srcset="assets/mobile/stdi@2x.webp">
    ...
    <div class="footer-wrapper">
      <footer class="grid">
        <div class="logo-footer">
          <a href="index.html">
            <picture>
              <source type=image/webp srcset="assets/mobile/logo-elmahad-footer.webp">
    ...
    <script>
      ...
      // fallback dekstop hero background image
      var img = document.createElement("img");
      img.onerror = function() {
        var style = document.createElement('style');
        style.innerHTML = "header { background-image: url('assets/dekstop/banner-dekstop.jpg'); }";
        document.head.appendChild(style);
      } 
      img.src = "assets/dekstop/banner-dekstop.webp";
